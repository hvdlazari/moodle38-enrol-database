...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_database/remoteperiodfield', get_string('remoteperiodfield', 'enrol_database'), get_string('remoteperiodfield_desc', 'enrol_database'), ''));
