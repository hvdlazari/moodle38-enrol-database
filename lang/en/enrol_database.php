...
$string['remoteperiodfield'] = 'Remote durantion field';
$string['remoteperiodfield_desc'] = 'The name of the field in the remote table that we are using to match entries in the duration table.';
